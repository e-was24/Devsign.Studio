...
function Home() {
  ...
  return (
    <div
      className={`Landing-Page ${isRiska ? "theme-riska" : ""} ${isVisitor ? "theme-visitor" : ""}`}
      ref={container}
    >
      {/* Navigasi tetap muncul kecuali kamu ingin menyembunyikannya di halaman tamu */}
      {!isVisitor && visible && !expired && !unrelease_page && !unrelease_page_rewind && (
        <div className="profile-menu">
          <NavLink
            to="/elan"
            className={({ isActive }) =>
              `menu-link code-link ${isActive ? "active" : ""}`
            }
            title="Elan page"
          >
          ...
          <NavLink
            to="/visitor"
            className={({ isActive }) =>
              `menu-link visitor-link ${isActive ? "active" : ""}`
            }
            title="guest page"
          >
          ...
          <NavLink
            to="/riska"
            className={({ isActive }) =>
              `menu-link dna-link ${isActive ? "active" : ""}`
            }
            title="Riska page"
          >
          ...
          <NavLink
            to="/journey"
            className={({ isActive }) =>
              `menu-link pwl-link ${isActive ? "active" : ""}`
            }
