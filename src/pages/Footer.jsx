    ...
    <footer className="footer-container">
      <div className="footer-content">
        ...
        <div className="footer-brand">
          ...
          <p>
            Exploring the boundary between modern technology and the wonders of
            biomedical science.
          </p>
        </div>
        ...
        <div className="footer-socials">
          ...
          <div className="social-icons">
            ...
            <a
              href="https://wa.me/6288740007150"
              target="_blank"
              rel="noopener noreferrer"
              title="Whatsapp"
            >
            ...
            <a
              href="https://www.instagram.com/qnsis__?igsh=MXhva2JyaHdyZGp2Ng=="
              target="_blank"
              rel="noopener noreferrer"
              title="Instagram"
            >
